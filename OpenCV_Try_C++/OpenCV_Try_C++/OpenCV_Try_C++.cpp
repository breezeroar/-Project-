...
// OpenCV_Try_C++.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(COpenCVTryCApp, CWinApp)
...
// 唯一一個 COpenCVTryCApp 物件

COpenCVTryCApp theApp;


// COpenCVTryCApp 初始化

BOOL COpenCVTryCApp::InitInstance()
{
