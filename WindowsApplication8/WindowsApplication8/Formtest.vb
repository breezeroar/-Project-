...
Public Class frmMain
    ...
    Private Sub btnBAL_Click(sender As System.Object, e As System.EventArgs) Handles btnDemo.Click
        ...
        Else
            ...
            SerialPort.Write(cmdDemo.ToString & txtDemoOrder.Text & vbCrLf)
    ...
    Private Sub Button1_Click_1(sender As System.Object, e As System.EventArgs)
        ...
        Try
            ...
            InString += SerialPort.ReadExisting
    ...
    Private Sub btnBAL_Click_1(sender As System.Object, e As System.EventArgs) Handles btnBAL.Click
        ...
        Dim cmdBAL As String
        cmdBAL = Chr(2) & "70105" & Chr(3) & "00"
        ...
        Else
            ...
            Try
                ...
                For i = 0 To txtBALOrder.Text - 1
                    SerialPort.Write(cmdBAL.ToString & vbCrLf)
    ...
    Private Sub btnHome_Click(sender As System.Object, e As System.EventArgs) Handles btnHome.Click
        ...
        Else
            ...
            SerialPort.Write(cmdHome.ToString & vbCrLf)
        End If
    End Sub

    Private Sub RS232_DataReceived(sender As System.Object, e As System.IO.Ports.SerialDataReceivedEventArgs) Handles SerialPort.DataReceived
    ...
    Private Sub reBal(ByVal orderBal As Integer)
        ...
        cmdReBal = "BAL"
        Try
            SerialPort.Write(cmdReBal.ToString & vbCrLf)
